...
public class Verify {
  ...
  public static int getCounter (int id) {
    if (peer != null) {
      ...
      return gov.nasa.jpf.vm.JPF_gov_nasa_jpf_vm_Verify.getCounter__I__I(null, 0, id);
    } else {
      if (counter == null) {
  ...
  public static void resetCounter (int id) {
    if (peer != null){
      gov.nasa.jpf.vm.JPF_gov_nasa_jpf_vm_Verify.resetCounter__I__V(null, 0, id);
    } else {
  ...
  public static void setCounter (int id, int val) {
    if (peer != null){
      gov.nasa.jpf.vm.JPF_gov_nasa_jpf_vm_Verify.setCounter__II__V(null, 0, id, val);
    } else {
      if ((counter != null) && (id >= 0) && (id < counter.length)) {
        counter[id] = val;
      }
  ...
  public static int incrementCounter (int id) {
    if (peer != null){
      return gov.nasa.jpf.vm.JPF_gov_nasa_jpf_vm_Verify.incrementCounter__I__I(null, 0, id);
    } else {
      if (counter == null) {
        counter = new int[(id >= MAX_COUNTERS) ? id+1 : MAX_COUNTERS];
  ...
  public static void setBitInBitSet(int id, int bit, boolean value) {
    if (peer != null){
      ...
      gov.nasa.jpf.vm.JPF_gov_nasa_jpf_vm_Verify.setBitInBitSet__IIZ__V(null, 0, id, bit, value);
    } else {
  ...
  public static boolean getBitInBitSet(int id, int bit) {
    if (peer != null){
      // this is executed if we did run JPF
      return gov.nasa.jpf.vm.JPF_gov_nasa_jpf_vm_Verify.getBitInBitSet__II__Z(null, 0, id, bit);
